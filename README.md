...
6. Update the `schemaHash`, `operator` and `value` in scripts/set-request.js with verifier claim schema hash, respective operator and value if you have changed the schema in the query
